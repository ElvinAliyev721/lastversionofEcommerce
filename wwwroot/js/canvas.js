...
//get canvas and parent element
let canvas=document.querySelector('canvas');
let parent_canvas=canvas.parentElement;
let footer_logo=document.querySelector('.footer-logo')

parent_canvas.style.display="inline-block";
canvas.style.maxWidth="100%";
canvas.style.maxHeight="100%";
parent_canvas.style.maxHeight="100%";
parent_canvas.style.maxWidth="100%";
footer_logo.appendChild(parent_canvas)